...
kill_argparser.add_argument("pid", help="Process ID")
...
memdump_argparser.add_argument(
    "pid",
    help=("PID (Process ID) of the process. " 'Use the "ps" command to discover possible values'),
)
memdump_argparser.add_argument(
    "filename",
...
mount_macos_subparser = mount_subparsers.add_parser(
    "source",
    help="Source filesystem, possibly a URL including username and password",
)
